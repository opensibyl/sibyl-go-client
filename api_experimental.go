...
*/
func (a *EXPERIMENTALApiService) ApiV1RevStatGet(ctx context.Context) ApiApiV1RevStatGetRequest {
	return ApiApiV1RevStatGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *EXPERIMENTALApiService) ApiV1RevStatGetExecute(r ApiApiV1RevStatGetRequest) (*ServiceRevStat, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EXPERIMENTALApiService.ApiV1RevStatGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
